...
//     <Container fluid>
//     <h5 className="card-title"><Link className="single-build-link" to={singleBuildUrl}>
// {build.name}</Link></h5>
...
//     </ModalBody>
//     <ModalFooter>
//       <Button color="danger" onClick={this.toggle}>Take me back!</Button>
//       <Button color="success" onClick={this.deleteThis}>I am sure!</Button>
//     </ModalFooter>
//   </Modal>
// </div> }
